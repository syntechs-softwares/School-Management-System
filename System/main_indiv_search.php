...
$ad_id = $_GET['ad'];
$sel_sp = $con->query("SELECT * FROM `admin` WHERE `Id`='$ad_id'");
    ...
    <div>
        ...
        <form method="post" action="reg.php?ad=<?php echo $ad_id;?>">
          ...
          <select name="stype" style="float:right;width:50%">
           ...
           <option value="SPO">Sponsered</option>
          </select><br><br>
      ...
      <form method="post" action="main_indiv_search.php?cl=<?php echo $cl;?>&ad=<?php echo $ad_id;?>">
