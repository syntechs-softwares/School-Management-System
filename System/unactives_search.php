...
<?php if($row_sp["Register"] == '1'):?>
    ...
    <div style="padding:1% 1% 1% 1%;background:white; box-shadow: 3px 5px #540004;height:410px; overflow:scroll;border:5px solid black">
    <h2 style="font-weight:bold;background:black;color:white;padding:5px 5px 5px 10px"> Inactive People
      ...
      <?php $name2 = strtoupper($row2["FName"]);
      if(strpos($name2, $input)!== false):?>
