...
<th style="width:300px"><div style="float:right;height:40px;width:300px;overflow:auto">
    ...
    <div>
      ...
      <form method="post" action="Indiv_Indiv_search.php?cl=<?php echo $cl;?>&id=<?php echo $test;?>&ad=<?php echo $ad_id;?>">
      ...
      <?php $num = $row5["SID"];
        $sel = $con->query("SELECT * FROM registery WHERE `Id`= $num AND `Class`='$cl'");
