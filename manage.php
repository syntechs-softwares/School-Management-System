...
<th style="width:200px"><div style="width:100%">
    <form method="post" action="index.php" style="height:100%;width:100%">
          <input id="Log In" type="submit" value="Go to Log In" style="width:100%;font-size:20px;padding-top:2px;background:#000044;color:white;height:50px">
      </form>
...
<div style="box-shadow:10px 10px 10px 10px #540004;background:white;border:5px solid black">
    <center><div style="width:70%">
        <form method="post" action="admin_conf.php" style="height:100%;width:800px"><br>
          ...
          <input name="submit" type="submit" value="Continue" style="margin-left:5px;font-size:36px; width:800px;color:white;background:#007700"><br><br><br>
      </form></div></center>
</div>
</body>
</html>